...
if (isloggedin() and !isguestuser()) {
	...
	echo "<div align='center' style='margin-top:2px;'><div style='max-width:910px'><img src='images/popup-1.png' style='width:100%;height:auto;'></div></div>";
    echo "<div align='center' style='margin-top:10px;'><div style='max-width:910px'><a href='https://qib.securityeducation.com/' target='_blank'><img src='images/banner_en.png' style='width:100%;height:auto;'></a></div></div>";
	echo "<div align='center' style='margin-top:0px;'><div style='max-width:910px'><a href='https://qib.securityeducation.com/' target='_blank'><img src='images/banner_ar.png' style='width:100%;height:auto;'></a></div></div>";
	echo "<div align='center' style='margin-top:2px;'><div style='max-width:910px'><img src='images/popup-2.png' style='width:100%;height:auto;'></div></div>";
}
