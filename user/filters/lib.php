...
class user_filtering {
    ...
    public function __construct($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            ...
            $fieldnames = array('realname' => 1,'email' => 1,'username' => 1, 'lastname' => 1, 'firstname' => 1,   'city' => 1,
            ...
            if ($userfiltersdefault == '') {
                $userfiltersdefault = array('realname','email');

                // Otherwise, we split the enabled filters into an array.
            } else {
                $userfiltersdefault = explode(',', $userfiltersdefault);
            }
			$userfiltersdefault[]='email';
			$userfiltersdefault[]='username';
			//$userfiltersdefault[]='profile';
			//print_r($userfiltersdefault);
