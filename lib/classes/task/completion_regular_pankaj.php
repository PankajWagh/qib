            ...
            while (1) {
                ...
                if (!empty($completions)) {
                    ...
                    //if ($overallstatus)
					{
						...
						echo $sql ="select * from {course_completions} where course =$params->course and userid=$params->userid and timecompleted is NULL";
						...
						/************************** Course Completion Pankaj Wagh dt 11/Sept/2021 **************/
						 ...
						 $message = 'Dear '.fullname($user, true).',

						Congratulations, you have completed the assignment course <b>'.$course->fullname.'</b>.

						Thank you for participating,
						<b>The Learning Team</b>
