...
class enrol_manual_plugin extends enrol_plugin {
    ...
    public function edit_instance_form($instance, MoodleQuickForm $mform, $context) {
        ...
        $mform->addElement('duration', 'expirythreshold', 'Notification start (days before)', $options);
        $mform->addHelpButton('expirythreshold', 'expirythreshold', 'core_enrol');
        $mform->disabledIf('expirythreshold', 'expirynotify', 'eq', 0);
		
		
		 
        $mform->addElement('text', 'expirythresholdfrequency','Notification frequency (days)');
        $mform->disabledIf('expirythresholdfrequency', 'expirynotify', 'eq', 0);
