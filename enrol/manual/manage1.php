...
$departmentoptions = $divisionoptions = $groupoptions = $statusoptions = Array();
		...
		$sql = "SELECT  d.data,f.shortname
                                            FROM {user_info_field} f
                                            JOIN {user_info_data} d ON d.fieldid = f.id
											where d.data !='' group by f.shortname, d.data order by f.shortname, d.data";
...
<form id="assignform" method="post" action="<?php echo $PAGE->url ?>"><div>
  ...
  <table summary="" class="roleassigntable generaltable generalbox boxaligncenter" cellspacing="0">
	...
	<tr><td colspan="3">  <input class="btn btn-secondary" name="remove" id="filter"  type="submit"
    ...
    <tr>
      ...
      <td id="buttonscell">
          <div id="addcontrols">
			...
			<?php echo html_writer::select_time('days', 'timeend["day"]', $enddate,'',['id'=>'timeend_day']) .
						html_writer::select_time('months', 'timeend["month"]', $enddate,'',['id'=>'timeend_month']).
						html_writer::select_time('years', 'timeend["year"]', $enddate,'',['id'=>'timeend_year']).
						html_writer::select_time('hours', 'timeend["hour"]', $enddate,'',['id'=>'timeend_hour']).
						html_writer::select_time('minutes', 'timeend["minute"]', $enddate,'',['id'=>'timeend_minute']).
						html_writer::checkbox('enabled',1,false);
						; ?>
              </div>
          </div>
